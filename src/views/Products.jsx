...
const Products = () => {
  return (
    <div id = "products" 
    className = "flex flex-col 2xl:flex-row gap-[128px] 2xl:gap-2 2xl:justify-between mt-[160px] 2xl:mt-[270px] mb-[160px] max-w-[1490px]mx-auto px-10">
     <FadeIn delay={0.2} direction="right">
       <div className="flex flex-col">
          ...
          px-4 rounded-md w-fit border hover:border-black outline-none focus:outline-none ease-liner transition-all duration-350 mx-auto
          2xl:mx-0 mb-10 2xl:mb-0">
          <h5 className="text-lg lg:text-xl text-xl text-[#4ff4f4f] font-medium">
            {productsBtnText}
          </h5>
     ...
     <div className="w-full flex flex-col md:flex-row gap-[160px] md:gap-6">
      {products.map((product, i) => (
        <FadeIn key={i} delay={0.2} direction="left" fullWidth>
          <div className="h-[510px] relative flex-1 bg-[#C1D0E4] rounded-[50px] max-w-[500px]">
            ...
            <div className="absolute bottom-0 w-full bg-white h-[260px] rounded-b-[50px] shadow-md px-8 py-[26px] flex flex-col justify-between">
              <div>
